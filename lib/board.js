  ...
  Board.prototype.handleTileClick = function() {
    if (window.Rumble.SelectedUnit !== undefined) {
      ...
      if (window.Rumble.PathFinder[[i, j]]) {
        ...
        this.contextFunction.removeUnit(window.Rumble.SelectedUnit);
        window.Rumble.SelectedUnit.model.position.x = this.context.position.x;
        window.Rumble.SelectedUnit.model.position.y = this.context.position.y;
        this.contextFunction.addUnit(window.Rumble.SelectedUnit);
      }
